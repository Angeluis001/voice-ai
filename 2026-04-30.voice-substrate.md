...
- **Voice OUT — four-tier cascade:**
  1. **Kokoro** (default, already in [`val-core/src/voice_output.rs`](../../v_source/fusion-engines/libraries/val-core/src/voice_output.rs)) with four channels: chief_of_staff / hey_val / alert / field_worker.
...
Already coded in [`v_source/fusion-engines/libraries/val-core/src/voice_output.rs`](../../v_source/fusion-engines/libraries/val-core/src/voice_output.rs). Four channels mapped to Kokoro voices:
